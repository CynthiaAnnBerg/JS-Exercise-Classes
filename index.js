...
class Airplane {
 ...
 class Lambdasian {
   ...
   speak(){
     return `Hello my name is ${this.name}, I am from ${this.lcoation}`;
   }
 ...
 class Instructor extends Lambdasian{
   constructor(attrs){
     super(attrs);
     this.specialty = this.speciality;
 ...
 console.log(brit.grade(michael, 'JavaScript'));
 console.log(michael.listSubjects());
